      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="https://linktr.ee/MusicClub_IIITDM" className="px-8 py-3 bg-white text-purple-600 font-medium rounded-md hover:bg-gray-100 transition-colors duration-300">
              Join Now
            </Link>
